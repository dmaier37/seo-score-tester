...
<div style="max-width:640px;margin:0 auto;padding:40px 20px;">
  ...
  <div style="background:linear-gradient(135deg,rgba(108,71,255,0.2),rgba(108,71,255,0.05));border:1px solid rgba(108,71,255,0.4);border-radius:20px;padding:32px;text-align:center;margin-bottom:24px;">
    ...
    <p style="color:#8888aa;font-size:14px;margin:0 0 24px;line-height:1.6;">Book a free 30-minute call. We'll walk through your results, handle all the fixes for you, and improve your score every single month.</p>
...
<div style="max-width:600px;margin:0 auto;padding:40px 20px;">
  ...
  <div style="background:linear-gradient(135deg,rgba(108,71,255,0.2),rgba(108,71,255,0.05));border:1px solid rgba(108,71,255,0.4);border-radius:20px;padding:28px;text-align:center;margin-bottom:24px;">
    ...
    <p style="color:#555566;font-size:12px;margin:8px 0 0;">Or book a free call and We'll handle everything for you →<br><a href="https://calendar.app.google/vchpwuG2TZdY6d6DA" style="color:#a78bfa;">Schedule a free strategy call</a></p>
  </div>
